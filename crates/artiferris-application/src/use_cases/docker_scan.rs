...
use chrono::Utc;
use artiferris_domain::docker_registry::{Digest, DockerGrantedScope, DockerImageName, DockerManifestRepositoryPort, DockerTokenIssuerPort};
use artiferris_domain::docker_scan::{DockerImageScanRepositoryPort, DockerImageScanResult, DockerImageScannerPort};
...
mod tests {
    ...
    use artiferris_domain::docker_registry::{DockerManifest, DockerMediaType};
    use artiferris_domain::docker_scan::DockerVulnerability;
