...
use artiferris_domain::docker_registry::{ByteStream, Digest, DockerBlobStorePort, DockerImageName, DockerManifestRepositoryPort};
...
mod tests {
    ...
    fn hosted_repo(id: Uuid) -> artiferris_domain::package_repository::PackageRepositorySummary {
        artiferris_domain::package_repository::PackageRepositorySummary {
            ...
            repo_type: artiferris_domain::package_repository::RepositoryType::Hosted, remote_url: None, remote_username: None, remote_password: None, quota_bytes: None, retention_keep_last_n: None, group_members: vec![],
        }
    }
    ...
    async fn a_missing_blob_is_fetched_from_the_proxys_remote_registry() {
        ...
        repositories.insert(artiferris_domain::package_repository::PackageRepositorySummary {
            ...
            repo_type: artiferris_domain::package_repository::RepositoryType::Proxy, remote_url: Some("https://registry-1.docker.io".to_string()), remote_username: None, remote_password: None, quota_bytes: None, retention_keep_last_n: None, group_members: vec![],
        });
    ...
    async fn a_cyclic_group_configuration_resolves_without_hanging() {
        ...
        repositories.insert(artiferris_domain::package_repository::PackageRepositorySummary {
            ...
            repo_type: artiferris_domain::package_repository::RepositoryType::Group, remote_url: None, remote_username: None, remote_password: None, quota_bytes: None, retention_keep_last_n: None, group_members: vec![repo_b_id],
        });
        repositories.insert(artiferris_domain::package_repository::PackageRepositorySummary {
            id: repo_b_id,
            organization_id: Uuid::new_v4(), name: "group-b".to_string(), format: artiferris_domain::package_repository::RepositoryFormat::Docker,
            repo_type: artiferris_domain::package_repository::RepositoryType::Group, remote_url: None, remote_username: None, remote_password: None, quota_bytes: None, retention_keep_last_n: None, group_members: vec![repo_a_id],
        });
