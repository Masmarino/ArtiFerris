...
use artiferris_application::use_cases::user::{AuthenticateUserUseCase, ChangePasswordUseCase, CreateUserUseCase, DeleteUserUseCase, SetOrganizationAdminUseCase, SetSuperAdminUseCase};
...
use artiferris_domain::user::{TokenIssuerPort, UserRepositoryPort};
...
use artiferris_infrastructure::postgres::health::PostgresHealthCheck;
...
pub struct AppState {
    ...
    pub docker_uploads: Arc<dyn artiferris_application::use_cases::docker_upload::DockerUploadSessionPort>,
...
impl AppState {
    pub fn build(pool: PgPool, config: &Config) -> Self {
        ...
        let docker_uploads: Arc<dyn artiferris_application::use_cases::docker_upload::DockerUploadSessionPort> = Arc::new(
