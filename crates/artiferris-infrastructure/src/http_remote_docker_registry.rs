...
/// Matches `artiferris-docker`'s own manifest-push cap (`dispatch::MANIFEST_BODY_LIMIT_BYTES`).
const MAX_MANIFEST_RESPONSE_BYTES: usize = 10 * 1024 * 1024;
/// Matches `artiferris-docker`'s own blob-upload cap (`BLOB_BODY_LIMIT_BYTES`).
