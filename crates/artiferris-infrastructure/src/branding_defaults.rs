...
pub const DEFAULT_LOGO_BYTES: &[u8] = include_bytes!("../assets/artiferris-logo.png");
pub const DEFAULT_LOGO_CONTENT_TYPE: &str = "image/png";

pub const DEFAULT_FAVICON_BYTES: &[u8] = include_bytes!("../assets/artiferris-favicon.ico");
