...
use bunker_domain::docker_registry::{Digest, DockerImageName, DockerManifest, DockerManifestRepositoryPort, DockerMediaType};
...
mod tests {
    use super::*;
    use bunker_domain::docker_registry::DockerMediaType;
