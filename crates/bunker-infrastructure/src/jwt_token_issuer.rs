...
use bunker_domain::user::{TokenIssuerPort, VerifiedToken};
...
mod tests {
    ...
    fn a_docker_access_token_is_rejected_by_the_session_token_issuer() {
        ...
        let docker_token = bunker_domain::docker_registry::DockerTokenIssuerPort::issue(&docker_issuer, Uuid::new_v4(), Uuid::new_v4(), false, None).unwrap();
