...
use bunker_domain::docker_registry::{DockerAccessClaims, DockerGrantedScope, DockerTokenIssuerPort};
...
mod tests {
    ...
    fn a_session_token_is_rejected_by_the_docker_token_issuer() {
        ...
        let session_token = bunker_domain::user::TokenIssuerPort::issue(&session_issuer, Uuid::new_v4(), Duration::hours(12)).unwrap();
