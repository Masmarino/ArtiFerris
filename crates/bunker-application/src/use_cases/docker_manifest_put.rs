...
use bunker_domain::audit::{DockerRegistryEvent, EventPublisherPort};
use bunker_domain::docker_registry::{Digest, DockerBlobStorePort, DockerImageName, DockerManifest, DockerManifestRepositoryPort, DockerMediaType};
...
mod tests {
    ...
    use bunker_domain::docker_registry::{Digest, DockerImageName};
    ...
    fn repo_with_quota(id: Uuid, quota_bytes: Option<i64>) -> bunker_domain::package_repository::PackageRepositorySummary {
        bunker_domain::package_repository::PackageRepositorySummary {
            id,
            organization_id: Uuid::new_v4(),
            name: "myrepo".to_string(),
            format: bunker_domain::package_repository::RepositoryFormat::Docker,
            repo_type: bunker_domain::package_repository::RepositoryType::Hosted,
            remote_url: None,
