...
use bunker_domain::docker_registry::{ByteStream, Digest, DockerBlobStorePort, DockerImageName, DockerManifestRepositoryPort};
use bunker_domain::error::DomainError;
use bunker_domain::docker_remote::RemoteDockerRegistryPort;
use bunker_domain::package_repository::{PackageRepositoryQueryPort, PackageRepositorySummary};
use uuid::Uuid;
...
mod tests {
    ...
    use bunker_domain::docker_registry::{DockerImageName, DockerManifest, DockerMediaType};

    fn hosted_repo(id: Uuid) -> bunker_domain::package_repository::PackageRepositorySummary {
        bunker_domain::package_repository::PackageRepositorySummary {
            id,
            organization_id: Uuid::new_v4(), name: format!("repo-{id}"), format: bunker_domain::package_repository::RepositoryFormat::Docker,
            repo_type: bunker_domain::package_repository::RepositoryType::Hosted, remote_url: None, remote_username: None, remote_password: None, quota_bytes: None, retention_keep_last_n: None, group_members: vec![],
        }
    }
    ...
    async fn a_missing_blob_is_fetched_from_the_proxys_remote_registry() {
        let repositories = Arc::new(FakeRepositories::new());
        let repository_id = Uuid::new_v4();
        repositories.insert(bunker_domain::package_repository::PackageRepositorySummary {
            id: repository_id,
            organization_id: Uuid::new_v4(), name: "proxy-repo".to_string(), format: bunker_domain::package_repository::RepositoryFormat::Docker,
            repo_type: bunker_domain::package_repository::RepositoryType::Proxy, remote_url: Some("https://registry-1.docker.io".to_string()), remote_username: None, remote_password: None, quota_bytes: None, retention_keep_last_n: None, group_members: vec![],
        });
    ...
    async fn a_cyclic_group_configuration_resolves_without_hanging() {
        ...
        repositories.insert(bunker_domain::package_repository::PackageRepositorySummary {
            id: repo_a_id,
            organization_id: Uuid::new_v4(), name: "group-a".to_string(), format: bunker_domain::package_repository::RepositoryFormat::Docker,
            repo_type: bunker_domain::package_repository::RepositoryType::Group, remote_url: None, remote_username: None, remote_password: None, quota_bytes: None, retention_keep_last_n: None, group_members: vec![repo_b_id],
        });
        repositories.insert(bunker_domain::package_repository::PackageRepositorySummary {
            id: repo_b_id,
            organization_id: Uuid::new_v4(), name: "group-b".to_string(), format: bunker_domain::package_repository::RepositoryFormat::Docker,
            repo_type: bunker_domain::package_repository::RepositoryType::Group, remote_url: None, remote_username: None, remote_password: None, quota_bytes: None, retention_keep_last_n: None, group_members: vec![repo_a_id],
        });
