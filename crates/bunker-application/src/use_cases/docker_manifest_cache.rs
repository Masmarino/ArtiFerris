...
use bunker_domain::docker_registry::{DockerManifest, DockerManifestRepositoryPort};
...
mod tests {
    ...
    use bunker_domain::docker_registry::{DockerImageName, DockerMediaType};
    use uuid::Uuid;
    ...
    fn sample_manifest(repository_id: Uuid, image_name: &DockerImageName) -> DockerManifest {
        DockerManifest {
            ...
            digest: bunker_domain::docker_registry::Digest::of(b"proxied-manifest-bytes"),
