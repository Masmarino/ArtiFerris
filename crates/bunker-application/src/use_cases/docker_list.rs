...
use bunker_domain::docker_registry::{DockerImageName, DockerManifestRepositoryPort};
...
mod tests {
    ...
    use bunker_domain::docker_registry::{DockerImageName, DockerManifest, DockerMediaType, Digest};
    use bunker_domain::error::EventStoreError;
