...
use bunker_domain::audit::{AuditEntry, AuditQueryFilter, DockerRegistryEvent, EventPublisherPort, NpmPackageEvent, SecurityEvent};
use bunker_domain::docker_registry::{
...
use bunker_domain::docker_scan::{DockerImageScanRepositoryPort, DockerImageScanResult, DockerImageScannerPort, DockerVulnerability};
...
impl DockerBlobStorePort for FakeDockerBlobStore {
    ...
    async fn read_stream(&self, digest: &Digest) -> Result<bunker_domain::docker_registry::ByteStream, DomainError> {
