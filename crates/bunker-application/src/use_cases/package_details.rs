...
use bunker_domain::npm_package::{NpmPackageName, NpmPackageRepositoryPort};
use uuid::Uuid;
...
mod tests {
    ...
    use bunker_domain::npm_package::{NpmPackage, NpmPackageOrigin, NpmPackageVersion, NpmVersion};
