...
use bunker_domain::mfa::{BackupCodePort, TotpCredential, TotpCredentialPort};
...
pub struct GetMfaStatusUseCase {
    ...
    passkeys: Arc<dyn bunker_domain::webauthn::WebauthnCredentialPort>,
}

impl GetMfaStatusUseCase {
    pub fn new(totp: Arc<dyn TotpCredentialPort>, backup_codes: Arc<dyn BackupCodePort>, passkeys: Arc<dyn bunker_domain::webauthn::WebauthnCredentialPort>) -> Self {
