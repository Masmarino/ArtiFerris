...
use chrono::Utc;
use bunker_domain::docker_registry::{Digest, DockerGrantedScope, DockerImageName, DockerManifestRepositoryPort, DockerTokenIssuerPort};
use bunker_domain::docker_scan::{DockerImageScanRepositoryPort, DockerImageScanResult, DockerImageScannerPort};
...
mod tests {
    ...
    use bunker_domain::docker_registry::{DockerManifest, DockerMediaType};
    use bunker_domain::docker_scan::DockerVulnerability;
