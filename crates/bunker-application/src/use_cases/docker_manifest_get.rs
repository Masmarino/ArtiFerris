...
use bunker_domain::docker_registry::{Digest, DockerImageName, DockerManifest, DockerManifestRepositoryPort};
...
impl GetManifestUseCase {
    ...
    async fn execute_proxy(&self, repository_id: Uuid, repo: PackageRepositorySummary, image_name: &DockerImageName, reference: &str) -> Result<Option<DockerManifest>, ApplicationError> {
        ...
        Ok(Some(DockerManifest {
            ...
            media_type: bunker_domain::docker_registry::DockerMediaType::parse(&content_type).unwrap_or(bunker_domain::docker_registry::DockerMediaType::DockerV2Manifest),
            body: bytes.clone(),
