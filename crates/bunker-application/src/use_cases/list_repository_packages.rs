...
use bunker_domain::docker_registry::DockerManifestRepositoryPort;
use bunker_domain::docker_scan::DockerImageScanRepositoryPort;
use bunker_domain::npm_audit::DependencyAuditRepositoryPort;
use bunker_domain::npm_package::NpmPackageRepositoryPort;
use bunker_domain::package_repository::RepositoryFormat;
use uuid::Uuid;
...
mod tests {
    ...
    use bunker_domain::docker_scan::{DockerImageScanResult, DockerVulnerability};
    use bunker_domain::npm_audit::{DependencyAuditFinding, DependencyAuditResult, NpmAdvisory};
