...
use chrono::Utc;
use bunker_domain::npm_audit::{parse_advisories, DependencyAuditFinding, DependencyAuditRepositoryPort, DependencyAuditResult, NpmAuditPort};
use bunker_domain::npm_package::{NpmPackageName, NpmPackageRepositoryPort, NpmVersion};
...
mod tests {
    ...
    use bunker_domain::npm_audit::NpmAdvisory;
    use bunker_domain::npm_package::{NpmPackage, NpmPackageOrigin, NpmPackageVersion};
